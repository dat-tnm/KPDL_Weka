...
public class MyBlendingModel extends MyKnowledgeModel {
    ...
    public void buildBlendingModel(String filename) throws Exception{
        ...
        stacking.buildClassifier(this.trainset);
    }
    ...
    public void evaluateBlendingModel(String filename) throws Exception{
        ...
        eval.crossValidateModel(this.stacking, this.testset, folds, rnd);
    ...
    public void predictClassLabel(String fileIn, String fileOut) throws Exception{
        ...
        for (int i = 0; i < unlabel.numInstances(); i++) {
            double predict = this.stacking.classifyInstance(unlabel.instance(i));
